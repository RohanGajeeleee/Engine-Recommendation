...
class Feedback:
    ...
    def view():
        ...
        if results:
            for row in results:
                print(f"Employee ID: {row['employee_id']}, Employee Name: {row['employee_name']}, Menu ID: {row['menu_id']}, Menu Name: {row['menu_name']}, Comment: {row['comment']}, Rating: {row['rating']}, Date: {row['feedback_date']}")
        else:
