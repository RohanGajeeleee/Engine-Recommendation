...
class ProfileService:
    @staticmethod
    def update_profile(employee_id, dietary_preference, spice_level, cuisine_preference, sweet_tooth):
        try:
            profile = {
    ...
    @staticmethod
    def create_profile(employee_id, dietary_preference, spice_level, cuisine_preference, sweet_tooth):
        try:
            profile = {
                'employee_id': employee_id,
                'dietary_preference': dietary_preference,
    ...
    def get_user_preferences(employee_id):
        try:
            profile = ProfileRepository.get_profile(employee_id)
            if profile:
