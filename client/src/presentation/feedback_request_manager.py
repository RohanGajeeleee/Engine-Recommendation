...
class FeedbackRequestManager:
    ...
    def reply_to_request(self, employee_id):
        request = FeedbackRequestBuilder.fetch_feedback_requests_request(employee_id)
        ...
        feedback_reply = FeedbackRequestBuilder.reply_feedback_request(employee_id, request_id, menu_id, q1, q2, q3)
