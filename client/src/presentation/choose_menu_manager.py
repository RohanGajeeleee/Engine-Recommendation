...
from src.common.RequestBuilder import CurrentMenuRequestBuilder
...
class ChooseMenuManager:
    ...
    def choose_menu_items(self):
        send_request(DiscardMenuRequestBuilder.check_discarded_items_request())
        clear_request = CurrentMenuRequestBuilder.clear_current_menu_request()
        ...
        items_added = False
        view_request = MenuRequestBuilder.view_menu_request()
        ...
        while True:
            ...
            if item_id.lower() == 'done':
                if items_added:
                    finalize_request = CurrentMenuRequestBuilder.finalize_current_menu_request()
            ...
            add_request = CurrentMenuRequestBuilder.add_to_current_menu_request(item_id)
