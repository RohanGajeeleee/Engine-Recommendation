...
def insert_initial_data():
    ...
    try:
        ...
        for feedback in data['feedback']:
            cursor.execute(
                "INSERT INTO feedback (employee_id, menu_id, comment, rating, feedback_date) VALUES (%s, %s, %s, %s, %s)",
                (feedback['employee_id'], feedback['menu_id'], feedback['comment'], feedback['rating'], feedback['feedback_date'])
            )
